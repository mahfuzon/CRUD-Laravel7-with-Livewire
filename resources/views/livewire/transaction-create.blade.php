<div>
    <form wire:submit.prevent="post">
        <div class="mb-3">
            ...
            @error('cutomer_id') <p class="error" style="color: red">{{ $message }}</p> @enderror
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="berat_ikan" class="form-label">berat_ikan</label>
        ...
        <div class="mb-3">
            <label for="jlh_kantong" class="form-label">jlh_kantong</label>
        ...
        <div class="mb-3">
            <label for="harga_ikan" class="form-label">harga_ikan</label>
