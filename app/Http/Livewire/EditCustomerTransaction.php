...
class EditCustomerTransaction extends Component
{
    public $customer_id, $date, $berat_ikan, $jlh_kantong, $harga_ikan,
        $driver_id, $bayar, $modelId, $total_berat, $total_harga, $hutang, $keterangan, $customer, $driver;
    public function render()
    {
        $this->customer = Customer::all();
        $this->driver = Driver::all();
        return view('livewire.edit-customer-transaction');
    }
    ...
    public function post()
    {
        ...
        $this->resetErrorBag();
        $this->dispatchBrowserEvent('closeModalTransactionCustomer');
        $this->clearForm();
